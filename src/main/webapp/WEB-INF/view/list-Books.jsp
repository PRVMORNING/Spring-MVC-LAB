...
<body>
	...
	<div class="container">
		...
		<form action="/LibraryManagement3/books/search" class="form-inline">

			<!-- Add a button -->
			<a href="/LibraryManagement3/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/LibraryManagement3/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/LibraryManagement3/books/delete?bookId=${tempBook.id}"
